    ...
    <>
      <Layout>
        ...
        >
          ...
          <Box mt="4">
            <Heading className={styles.header1}>Acknowledgment</Heading>
            <Text className={styles.body}>
          ...
          <Box mt="4">
            <Heading className={styles.header1}>Termination</Heading>
            <Text className={styles.body}>
          ...
          <Box mt="4">
            <Heading className={styles.header1}>Governing Law</Heading>
            <Text className={styles.body}>
          ...
          <Box mt="4">
            <Heading className={styles.header1}>Disputes Resolution</Heading>
            <Text className={styles.body}>
            ...
            <Text className={styles.body}>For European Union (EU) Users</Text>
            <Text className={styles.body}>
            ...
            <Text className={styles.body}>United States Legal Compliance</Text>
            <Text className={styles.body}>
          ...
          <Box mt="4">
            <Heading className={styles.header1}>Contact Us</Heading>
            <Text className={styles.body}>
